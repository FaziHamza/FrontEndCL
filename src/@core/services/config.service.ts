...
export class CoreConfigService {
    ...
    private _topMenuConfig: BehaviorSubject<boolean>;
    ...
    set hasTopMenu(val) {
        this._topMenuConfig.next(val as boolean);
    }

    get hasTopMenu(): boolean | Observable<boolean> {
        return this._topMenuConfig.asObservable();
    }
    ...
    private _initConfig(): void {
        ...
        this._topMenuConfig = new BehaviorSubject<boolean>(false);
