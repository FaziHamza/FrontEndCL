...
export class CoreSidebarComponent implements OnInit, OnDestroy {
    ...
    set collapsed(value: boolean) {
        ...
        // If Expanded
            ...
            //TODO: NOTE: Should remove this for the Functionality to re-implement it.
    ...
    onMouseEnter(): void {
        ...
        //NOTE: Uncomment Below to Enable Expansion
    ...
    onMouseLeave(): void {
        ...
        //NOTE: Uncomment Below to Enable Collapsation
