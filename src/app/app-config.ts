 ...
 * You can also change them on each component basis. i.e `app/main/authentication/auth-login-v1/auth-login-v1.component.ts`
 *
...
export const coreConfig: CoreConfig = {
    app: {
        appName: 'CliCong',                                        // App Name
        appTitle: 'CliCong - Client Connecting', // App Title
