...
export class ReminderComponent implements OnInit, AfterViewInit {
     ...
     * @param {ReminderService} _reminderService
    ...
    handleUpdateEventClick(eventRef: EventClickArg) {
        ...
        this._reminderService.updateCurrentEvent(eventRef);
    }
    ...
    handleDateSelect(eventRef) {
        ...
        this._coreSidebarService.getSidebarRegistry('calendar-event-sidebar').toggleOpen();
        this._reminderService.onCurrentEventChange.next(newEvent);
    }
    ...
    ngOnInit(): void {
        ...
        this._coreConfigService.config.pipe(takeUntil(this._unsubscribeAll)).subscribe(config => {
            ...
            if (config.layout.animation === 'zoomIn') {
                setTimeout(() => {
                    ...
                    this._reminderService.onEventChange.subscribe(res => {
                        this.events = res;
        ...
        this._reminderService.onCurrentEventChange.subscribe(res => {
            this.event = res;
        });
    }
