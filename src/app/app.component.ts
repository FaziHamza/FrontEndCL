    ...
    ngOnInit(): void {
        ...
        this.router.events.subscribe(value => {
            if (value instanceof RoutesRecognized) {
                console.log(value);
                let hasTopMenu = value.state?.root?.firstChild?.firstChild?.data?.hasTopMenu;
                console.log(hasTopMenu);
                this._coreConfigService.hasTopMenu = hasTopMenu === null || hasTopMenu === undefined ? false : hasTopMenu;
                let ve = document.getElementsByClassName('vertical-layout')[0];
                // ve.classList.remove('menu-expanded');
                // ve.classList.add('menu-collapsed');
            }
            // console.log(value, this.activatedRoute);
            // this._coreConfigService.hasTopMenu = false;
            // console.log(this.activatedRoute.snapshot, this.activatedRoute.firstChild);
        })
        // this.router.events
        //     .pipe(
        ...
        //         map(data => data['hasTopMenu'])).subscribe(value => {
        //     console.log("hasTopMenu", value);
        // })
